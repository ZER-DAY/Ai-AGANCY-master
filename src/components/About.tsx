        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded shadow">
              ...
              <p className="text-gray-600">
                نحن في شركة الأصيل، نعتبر أنفسنا روادًا في مجال التسويق الرقمي،
                ...
                وتحديدًا في مدينة غزة على شارع الوحدة بالقرب من برج الجوهرة.
                يمكنكم التواصل معنا عبر الرقم 00970598707089. في عام 2021، وسعت
                شركة الأصيل لتنمية الموارد البشرية وتكنولوجيا المعلومات نشاطاتها
                إلى تركيا، حيث افتتحنا فرعنا في إسطنبول، بلكدوزو، لتكون نقطة
                انطلاق جديدة في رحلتنا نحو العالمية. يمكنكم الاتصال بفرعنا في
                إسطنبول عبر الرقم 00905526966689. وفي إطار سعينا الدائم للتوسع
                وتقديم خدماتنا لأكبر عدد من العملاء، حصلنا في عام 2024 على ترخيص
                للعمل في سلطنة عُمان، حيث يقع مكتبنا في مسقط، الخوير بالقرب من
                عُمان مول. للتواصل مع فرعنا في عُمان، يمكنكم الاتصال على الرقم
                0096879445665. نلتزم في الأصيل بتقديم خدمات تسويق رقمي تتميز
                بالجودة والابتكار، مع التركيز على بناء علاقات قوية ومستدامة مع
                عملائنا. نحن هنا لنساعدكم في تحقيق أهدافكم التسويقية وتطوير
                استراتيجياتكم الرقمية بما يتماشى مع أحدث التطورات التكنولوجية،
                مع الحفاظ على القيم والعادات الأصيلة للمجتمعات التي نخدمها.
              </p>
            </div>
            <div className="bg-white p-6 rounded shadow">
              <p className="text-gray-600">
